...
const reviews = [
  {
    client: { first_name: "John Duran" }, // Using another expert as a client for demo
    rating: 5,
    review: "Exceptional work! The logo perfectly captures our brand essence.",
    date: "2025-05-15",
  },
  {
    client: { first_name: "Mike Brown" },
    date: "February 25, 2025",
    rating: 4.9,
    review:
      "I recently collaborated with an outstanding freelance designer who really impressed me. With three years of experience under their belt, they offered a unique viewpoint that greatly enhanced my project. Their commitment to grasping my business requirements was clear, and the final designs were beyond what I had hoped for. I wholeheartedly recommend their services to anyone in search of exceptional design!",
  },
  {
    client: { first_name: "Sule Madu" },
    date: "February 25, 2025",
    rating: 2.9,
    review:
      "I recently collaborated with an outstanding freelance designer who really impressed me. With three years of experience under their belt, they offered a unique viewpoint that greatly enhanced my project. Their commitment to grasping my business requirements was clear, and the final designs were beyond what I had hoped for. I wholeheartedly recommend their services to anyone in search of exceptional design!",
...
export default function ExpertDetailsPage() {
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      case "about":
        return (
          <AboutTab about={about} experience={experience} skills={skills} />
        );
      case "work":
        return <WorkTab work={profileData.work} />;
      case "offers":
        //change to profileData.offers
        return <Offers offers={offersData} />;
      case "reviews":
        return <Ratings ratings={reviews} />;
      case "skills":
    ...
    <div className="container mx-auto px-5 flex flex-col min-h-screen">
      ...
      <div className="relative rounded-lg overflow-hidden border-2 border-gray-300 gap-4 h-auto">
        ...
        <div className="pt-20 px-6 pb-9 flex justify-between items-start">
          <div>
            <h2 className="text-accent-color-700 font-bold text-2xl">
            ...
            <div className="flex items-center space-x-2 text-sm  mt-1">
              ...
              <span className="text-green-500 font-normal">
                Verified Expert in {verified.field}
              </span>
            </div>
          ...
          <div className="flex space-x-3">
            ...
            <button
              className={`bg-white w-[41.5px] h-[41.5px] shadow-md rounded-md items-center justify-center flex ${
                liked ? "text-red-500" : "text-primary-700"
        ...
        <div className="flex space-x-6">
          {["about", "work", "offers", "reviews"].map((tab) => (
            ...
            >
              <span
                className={`${
                  activeTab === tab ? "text-accent-color-700" : ""
                }`}
              >
