...
import { ArrowRightSquareIcon, BellIcon, SearchIcon } from "lucide-react"
...
export default function DashboardNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-purple-100 bg-white md:px-[50px] py-[24px] shadow-md">
      <div className="flex items-center ">
        <div>
          {!isOpen && <button onClick={toggleSidebar} className="p-4 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
            <ArrowRightSquareIcon className="h-7 w-12" />
          </button>}
        </div>
